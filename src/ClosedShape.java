...
public class ClosedShape {
	...
	/**
	 * The pulsing rate of the each object.
	 */
	public static int pulseRate = -1;
	...
	/**
	 * @return True if the shape pulsing, false if not.
	 */
	 ...
	 */
	public void pulsing() {
		System.out.println("You forgot to override this method! (pulsing)");
